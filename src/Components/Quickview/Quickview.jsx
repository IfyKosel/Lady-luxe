  ...
  return (
    <>
      ...
      {showModal && (
        ...
        >
          {/* <div
            className="custom-modal-wrapper bg-danger"
            ...
            <Container fluid>
              <Row>
                ...
                <Col md={6} className="text-black text-start">
                  ...
                  <p className="quantity my-2 text-center text-md-start">
                    Quantity
                  </p>
                  ...
                  <div className="d-flex w-100 column-gap-2 mb-2 justify-content-center justify-content-md-start">
                    <button
                      type="button"
